module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/J6a2QR2fd5fCwBJ7xWrarG'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         groupmode: true,
         sk_pack: 'Sticker by',
         sk_author: '© andymrllit',
         self: false,
         noprefix: false,
         multiprefix: true,
         prefix: ['.', '#', '!', '/'],
         toxic: ["ajg", "ajig", "anjas", "anjg", "anjim", "anjing", "anjrot", "anying", "asw", "autis", "babi", "bacod", "bacot", "bagong", "bajingan", "bangsad", "bangsat", "bastard", "bego", "bgsd", "biadab", "biadap", "bitch", "bngst", "bodoh", "bokep", "cocote", "coli", "colmek", "comli", "dajjal", "dancok", "dongo", "fuck", "gelay", "goblog", "goblok", "guoblog", "guoblok", "hairul", "henceut", "idiot", "itil", "jamet", "jancok", "jembut", "jingan", "kafir", "kanjut", "kanyut", "keparat", "kntl", "kontol", "lana", "loli", "lont", "lonte", "mancing", "meki", "memek", "ngentod", "ngentot", "ngewe", "gyet", "ngtd", "njeng", "njing", "njinx", "oppai", "pantek", "pantek", "peler", "pepek", "pilat", "pler", "pornhub", "pucek", "puki", "pukimak", "redhub", "sange", "setan", "zozo", "telaso", "tempek", "tete", "titit", "toket", "tolol", "tomlol", "tytyd", "andy", "xnxx"],
         online: true,
         onlyprefix: '+',
         owners: ['50937069302'],
         lastReset: new Date * 1,
         msg: 'Hello +tag Good Afternoon! I am a WhatsApp bot created by andy which comes with cool features like creating stickers, sending songs, searching videos and much more. I am here to help you in a variety of ways, including submitting.\n\n◦ *Database* : Mongo\n◦ *Library* : Baileys@adiwajshing/baileys\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 2,
         cover: 'https://telegra.ph/file/aabe3bbaa00faa3330e9e.png',
         link: 'https://chat.whatsapp.com/J6a2QR2fd5fCwBJ7xWrarG'
      }
   }
}
